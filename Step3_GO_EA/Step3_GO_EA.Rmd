...
mft <- enrichGO(t, OrgDb = org.Hs.eg.db, keyType = "ENSEMBLTRANS", ont = "MF", pAdjustMethod = "fdr", universe = trans)
results10 <- dplyr::as_tibble(as.data.frame(mft@result))

ct <- enrichGO(t, OrgDb = org.Hs.eg.db, keyType = "ENSEMBLTRANS", ont = "CC", pAdjustMethod = "fdr", universe = trans)
results10 <- dplyr::as_tibble(as.data.frame(bpt@result))
